...
const Register = () => {
  ...
  const onSubmit = (data) => {
    mutate({ ...data, avatar: "https://i.ibb.co/fSfHpjc/img20.png" });
  };
  return (
    <div className="flex justify-center items-center min-h-screen font-konit">
      <div className="w-2/6 p-10 shadow-md rounded-xl border border-[#4BD16F]">
        <img src={logo} className="w-2/5 mx-auto mb-8" alt="" />
        <div>
          {registerError && (
            <p className="text-red-500 mb-3">{registerError}</p>
          )}
            ...
            <div>
              ...
              >
                <div
                  ...
                  onClick={() => setAnimate({ ...animate, userName: true })}
                  onBlur={(e) =>
                    e.target.value
                      ? setAnimate({ ...animate, userName: true })
                      : setAnimate({ ...animate, userName: false })
                  }
                >
                  <input
                  ...
                  <span
                    className={`text-gray-500 text-xl absolute left-4 top-2 transition-all ease-linear ${
                      animate.userName && "-top-0 text-sm"
                    }`}
                  >
                    Name
                  </span>
                ...
                <div
                  className={`w-12 flex justify-center items-center text-2xl bg-[#4BD16F] text-white ${
                    errors?.userName?.message && "bg-red-400"
                  }`}
                >
                  <BiUser />
                </div>
